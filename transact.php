...
if(isset($_POST['submit'])){
  ...
  // $sql1="select * from clients where id=$from";
  // $q1=mysqli_query($conn,$sql1);
  // $arr1=mysqli_fetch_array($q1);


  // $sql2="select * from clients where id=$touser";
  // $q2=mysqli_query($conn,$sql2);
  // $arr2=mysqli_fetch_array($q2);
  ...
  if($amt>$arr1['amount']){
    ...
    // $sql1="UPDATE clients set amount=$newcred1 where id=$from";
    // $qq1=mysqli_query($conn,$sql1);

    // $sql2="UPDATE clients set amount=$newcred2 where id=$touser";
    // $qq2=mysqli_query($conn,$sql2);
